...
/// <summary>
/// Measures indexing overhead when token budget enforcement is enabled versus disabled.
/// </summary>
[MemoryDiagnoser]
[HtmlExporter]
...
public class TokenBudgetBenchmarks
{
    ...
    public int LeanCorpus_Index_NoBudget() => IndexWithConfig(new IndexWriterConfig
    {
    ...
    [Benchmark]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public int LeanCorpus_Index_WithBudget_Truncate() => IndexWithConfig(new IndexWriterConfig
    {
        MaxBufferedDocs = 10_000,
        RamBufferSizeMB = 256,
    ...
    [Benchmark]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public int LeanCorpus_Index_WithBudget_Reject() => IndexWithConfig(new IndexWriterConfig
    {
        MaxBufferedDocs = 10_000,
        RamBufferSizeMB = 256,
        MaxTokensPerDocument = 100,
    ...
    private int IndexWithConfig(IndexWriterConfig config)
    {
        ...
        for (int i = 0; i < _documents.Length; i++)
        {
            ...
            {
                // Expected in Reject mode: the document is skipped.
            }
        }
