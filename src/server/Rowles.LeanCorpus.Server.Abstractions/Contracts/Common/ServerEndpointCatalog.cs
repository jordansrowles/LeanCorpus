...
public static class ServerEndpointCatalog
{
    ...
    [
        new("GET", "/v1/health", ApiEdition.Community, EndpointAccess.Public, OperationKind.ReadHealth, []),
        new("GET", "/v1/ready", ApiEdition.Community, EndpointAccess.Public, OperationKind.ReadReadiness, []),
        new("GET", "/v1/indices", ApiEdition.Community, EndpointAccess.Public, OperationKind.ListIndexes, [InterceptionPort.Authorisation]),
        new("PUT", "/v1/indices/{name}", ApiEdition.Community, EndpointAccess.Administrative, OperationKind.CreateIndex, [InterceptionPort.Authorisation, InterceptionPort.Lifecycle, InterceptionPort.Audit]),
        new("DELETE", "/v1/indices/{name}", ApiEdition.Community, EndpointAccess.Administrative, OperationKind.DeleteIndex, [InterceptionPort.Authorisation, InterceptionPort.Lifecycle, InterceptionPort.Audit]),
        new("PATCH", "/v1/indices/{name}/settings", ApiEdition.Community, EndpointAccess.Administrative, OperationKind.UpdateIndexSettings, [InterceptionPort.Authorisation, InterceptionPort.Audit]),
        new("POST", "/v1/indices/{name}/documents:bulk", ApiEdition.Community, EndpointAccess.Public, OperationKind.WriteDocuments, [InterceptionPort.Authorisation, InterceptionPort.Routing, InterceptionPort.WriteAcknowledgement, InterceptionPort.Audit]),
        new("POST", "/v1/indices/{name}/refresh", ApiEdition.Community, EndpointAccess.Public, OperationKind.RefreshIndex, [InterceptionPort.Authorisation, InterceptionPort.Audit]),
        new("POST", "/v1/indices/{name}/search", ApiEdition.Community, EndpointAccess.Public, OperationKind.Search, [InterceptionPort.Authorisation, InterceptionPort.Routing, InterceptionPort.Consistency, InterceptionPort.Audit]),
        new("GET", "/v1/indices/{name}/schema", ApiEdition.Community, EndpointAccess.Public, OperationKind.ReadIndexMetadata, [InterceptionPort.Authorisation]),
        new("GET", "/v1/indices/{name}/stats", ApiEdition.Community, EndpointAccess.Public, OperationKind.ReadIndexMetadata, [InterceptionPort.Authorisation]),
        new("GET", "/v1/indices/{name}/inspection/{resource}", ApiEdition.Community, EndpointAccess.Administrative, OperationKind.Inspect, [InterceptionPort.Authorisation, InterceptionPort.Inspection, InterceptionPort.Audit]),
