...
/// <summary>Matches documents by a document-level relationship to a geographic shape.</summary>
/// <remarks>
...
/// </remarks>
public sealed class GeoShapeQuery : Query
{
    /// <summary>Creates a geographic shape query.</summary>
    /// <param name="field">The indexed geographic shape field.</param>
    ...
    public GeoShapeQuery(string field, SpatialRelation relation, IGeoGeometry geometry)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(field);
        ArgumentNullException.ThrowIfNull(geometry);
        if (!Enum.IsDefined(relation))
            throw new ArgumentOutOfRangeException(nameof(relation));
        ShapeTessellator.ValidateGeoQueryGeometry(geometry);
        Field = field;
        Relation = relation;
        Geometry = geometry;
    }
    ...
    /// <summary>Gets the geographic query geometry.</summary>
    public IGeoGeometry Geometry { get; }

    /// <inheritdoc/>
    public override bool Equals(object? obj)
        => obj is GeoShapeQuery other
            && Field == other.Field
    ...
    public override int GetHashCode()
        => HashCode.Combine(nameof(GeoShapeQuery), Field, Relation, Geometry, Boost);
}
