...
internal static class CodecCatalogBuiltIns
{
    ...
    [
        ...
        Family("leancorpus.doc-values", "DocValues",
            ...
            VersionedFile("leancorpus.doc-values.shape", "leancorpus.doc-values", "Shape DocValues", ".dvg", CodecConstants.ShapeDocValuesVersion, CodecAccessKind.RandomAccess,
                currentMigrationBehaviour: CodecMigrationBehaviour.None,
                legacyFraming: CodecLegacyFraming.None)),
        Family("leancorpus.numeric-structures", "Numeric structures",
            ...
            VersionedFile("leancorpus.numeric-structures.packed-bkd", "leancorpus.numeric-structures", "Packed multidimensional BKD", ".pbkd", CodecConstants.PackedBkdVersion, CodecAccessKind.RandomAccess,
                currentMigrationBehaviour: CodecMigrationBehaviour.None,
                legacyFraming: CodecLegacyFraming.None),
