...
internal static class CodecFormatTable
{
    private static readonly Dictionary<string, CodecFormatDescriptor> Descriptors = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        [".fdt"] = new("Stored fields data", CodecConstants.StoredFieldsVersion, HasHeader: true, HeaderFormat: null),
        [".fdx"] = new("Stored fields index", CodecConstants.StoredFieldsVersion, HasHeader: true, HeaderFormat: null),
