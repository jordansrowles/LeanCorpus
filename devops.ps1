...
function Get-SuiteMap {
    [ordered]@{
        ...
        'pq-quality'         = 'Product quantisation quality sweep without HNSW or BenchmarkDotNet'
        'pq-confirm'         = 'Product quantisation 100K confirmation without HNSW or BenchmarkDotNet'
        hybrid               = 'HybridRetrievalBenchmarks'
