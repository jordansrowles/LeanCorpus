...
function Invoke-DevOpsHelp {
    ...
    Write-Host '      -RuntimeAsync        Enable the net11.0 Runtime Async experiment for this build'
    Write-Host ''
    ...
    Write-Host '      -RuntimeAsync        Enable the net11.0 Runtime Async experiment'
    Write-Host '      -NoRestore           Use existing restored packages and skip restore'
