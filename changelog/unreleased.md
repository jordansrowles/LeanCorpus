...
- Restrict recoverable document rejections to validation before DWPT mutation, release fatal-reconciliation backpressure before admitted peers unwind, and restore sequence numbering from zero for empty committed indexes.
