...
- `WhitespaceAnalyser`: splits only on whitespace, preserving punctuation and case; no token filters applied. Requested by [@umlx5h](https://github.com/umlx5h) in #12.
