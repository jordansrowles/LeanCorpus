...
- `PrefixQuery` and `WildcardQuery` now return each matching document once when multiple matched terms occur in the same document. Reported by [@umlx5h](https://github.com/umlx5h) in #9.
