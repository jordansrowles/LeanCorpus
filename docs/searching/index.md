...
Every query derives from `Query`. Browse by topic.

- [Query types overview](01-query-types.md)
- [Boolean queries](02-boolean-queries.md)
- [Phrase and proximity](03-phrase-and-proximity.md)
- [The query parser](04-query-parser.md)
- [Boosting and scoring](05-boosting-and-scoring.md)
