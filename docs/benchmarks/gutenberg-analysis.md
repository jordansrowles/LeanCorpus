...
|---------------------------- |----------:|---------:|---------:|------:|----------:|------------:|
| LeanCorpus_Standard_Analyse |  78.88 ms | 0.106 ms | 0.094 ms |  1.00 |         - |          NA |
| LeanCorpus_English_Analyse  | 185.79 ms | 0.093 ms | 0.078 ms |  2.36 |         - |          NA |
...
<p><a href="gutenberg-analysis.json">Full results as JSON</a></p>
</div>
